...
final class FormPresentationResolver
{
    ...
    public function resolve(FormTemplateKind $kind, array $configs): array
    {
        ...
        $rounded = (int) ($configs['contact_rounded_input'] ?? 0);
        $py = (int) ($configs['contact_py_input'] ?? 2);
        $my = (int) ($configs['contact_my_input'] ?? 2);
        ...
        return [
            ...
            'bgcolor_input' => (string) ($configs['contact_bgcolor_input'] ?? '#ffffff'),
            'color_input' => (string) ($configs['contact_color_input'] ?? '#000000'),
            'border_color_input' => (string) ($configs['contact_border_color_input'] ?? '#dee2e6'),
