...
final class FooterSectionController extends AbstractController
{
    ...
    public function index(SectionRepository $sectionRepository): Response
    {
        return $this->render('admin/footer_section/index.html.twig', [
            'sections' => $sectionRepository->findFooterSections(),
        ]);
    }

    #[Route('/new', name: 'new', methods: ['POST'])]
    public function new(FooterSectionService $footerSectionService): Response
    {
        $section = $footerSectionService->createSection();
